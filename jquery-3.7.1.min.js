...
!function (e, t) {
    ...
    ce.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
            ...
            "scripts" === l && (e.style.position = "relative"), s = c.offset(), o = ce.css(e, "top"), u = ce.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), v(t) && (t = t.call(e, n, ce.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, ce.fn.extend({
        offset: function (t) {
            ...
            if (this[0]) {
                ...
                if ("fixed" === ce.css(r, "position")) t = r.getBoundingClientRect(); else {
                    ...
                    while (e && (e === n.body || e === n.documentElement) && "scripts" === ce.css(e, "position")) e = e.parentNode;
            ...
            return this.map(function () {
                ...
                while (e && "scripts" === ce.css(e, "position")) e = e.offsetParent;
                return e || J
            })
        }
...
$(document).ready(function () {
    $("#en").click(function () {
        ...
        $(".contacts-h2").text("Tech Skills");
        $(".contacts-layout").text("Adaptive layout");
        $(".contacts-skills").text("Soft Skills");
        $(".communication").text("Communication");
        $(".teamwork").text("Teamwork");
        $(".creativity").text("Creativity");
        $(".problem_solving").text("Problem solving");
        $(".leadership").text("Leadership");
        $(".organization").text("Organization");
        $(".interpersonal_skills").text("Interpersonal skills");
        $(".front").text("Front-End Developer");
        $(".viktor").text("Viktor Zygalski");
        $(".text-front").text("Frontend developer with no experience. Participated in the creation of more than 15 websites.");
        $(".projects").text("Projects");
        $(".employment").text("Employment");
        $(".part-time").text("part-time");
        $(".full-time").text("(full-time)");
        $(".education-in").text("Education");
        $(".university").text("Belarusian National Technical University");
        $(".engineer").text("Mechanical engineer");
        $(".engineer-text").text("September 1992 - June 1998 | Belarusian");
        $(".itlogia").text("Itlogia");
        $(".itlogia-text").text("September 2023 - September 2024 | Belarusian");
        $(".job").text("Job responsibilities");
        $(".job-a").text("Layout of web pages according to the layout");
        $(".job-b").text("Writing the logic of button operation");
        $(".job-c").text("Introduction of new components into existing projects");

    });
    $("#ru").click(function () {
        $(".contacts").text("Контакт");
        $(".contacts-h2").text("Технические навыки");
        $(".contacts-layout").text("Адаптивная верстка");
        $(".contacts-skills").text("Навыки");
        $(".communication").text("Коммуникабильность");
        $(".teamwork").text("Командная работа");
        $(".creativity").text("Креативность");
        $(".problem_solving").text("Решение проблем");
        $(".leadership").text("Лидерство");
        $(".organization").text("Организованность");
        $(".interpersonal_skills").text("Межличностные навыки");
        $(".front").text("Фронтенд-разработчик");
        $(".viktor").text("Виктор Жигальский");
        $(".text-front").text("Фронтенд-разработчик без опыта. Участвовал в создании более 15 сайтов.");
        $(".projects").text("Проекты");
        $(".employment").text("Занятость");
        $(".part-time").text("неполная занятость");
        $(".full-time").text("(полная занятость)");
        $(".education-in").text("Образование");
        $(".university").text("Белорусский национальный технический университет");
        $(".engineer").text("Инженер-механик");
        $(".engineer-text").text("сентябрь 1992 г. - июнь 1998 г. | Беларусь");
        $(".itlogia").text("Айтилогия");
        $(".itlogia-text").text("Сентябрь 2023 г. – Сентябрь 2024 г. | Беларусь");
        $(".job").text("Должностные обязанности");
        $(".job-a").text("Верстка веб-страниц согласно макету");
        $(".job-b").text("Написание логики работы кнопок");
        $(".job-c").text("Внедрение новых компонентов в существующие проекты");
    });
    $("#pl").click(function () {
        $(".contacts").text("Kontakt");
        $(".contacts-h2").text("Umiejętności techniczne");
        $(".contacts-layout").text("Układ adaptacyjny");
        $(".contacts-skills").text("Umiejętności");
        $(".communication").text("Komunikatywność");
        $(".teamwork").text("Pracy zespołowej");
        $(".creativity").text("Kreatywność");
        $(".problem_solving").text("Rozwiązywanie problemów");
        $(".leadership").text("Przywództwo");
        $(".organization").text("Organizacja");
        $(".interpersonal_skills").text("Umiejętności interpersonalne");
        $(".front").text("Programista front-end");
        $(".viktor").text("Wiktor Żygalski");
        $(".text-front").text("Programista front-end bez doświadczenia. Brał udział w tworzeniu ponad 15 witryn.");
        $(".projects").text("Projekty");
        $(".employment").text("Zatrudnienie");
        $(".part-time").text("Zatrudnienie w niepełnym wymiarze czasu pracy");
        $(".full-time").text("(Zatrudnienie na pełen etat)");
        $(".education-in").text("Edukacja");
        $(".university").text("Białoruski Narodowy Uniwersytet Techniczny");
        $(".engineer").text("Inżynier mechanik");
        $(".engineer-text").text("wrzesień 1992 do czerwiec 1998 | Białoruś");
        $(".itlogia").text("Itlogia");
        $(".itlogia-text").text("wrzesień 2023 – wrzesień 2024 | Białoruś");
        $(".job").text("Obowiązki zawodowe");
        $(".job-a").text("Układ stron internetowych zgodnie z układem");
        $(".job-b").text("Pisanie logiki dla przycisków");
        $(".job-c").text("Wdrażanie nowych komponentów w istniejących projektach");
    });
});
